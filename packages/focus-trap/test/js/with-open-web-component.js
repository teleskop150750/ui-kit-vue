...
export default () => {
  const container = document.querySelector('#with-open-web-component')
  ...
  document.querySelector('#activate-with-open-web-component').addEventListener('click', focusTrap.activate)
  document.querySelector('#deactivate-with-open-web-component').addEventListener('click', focusTrap.deactivate)
}

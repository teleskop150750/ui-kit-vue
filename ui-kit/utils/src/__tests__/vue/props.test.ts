...
describe('Types', () => {
  ...
  it('ResolvePropType', () => {
    ...
    expectTypeOf<ResolvePropType<[DateConstructor, NumberConstructor]>>().toEqualTypeOf<Date | number>()
    expectTypeOf<ResolvePropType<readonly [DateConstructor, NumberConstructor]>>().toEqualTypeOf<Date | number>()
    expectTypeOf<ResolvePropType<PropType<string | 12 | false>>>().toEqualTypeOf<string | 12 | false>()
    expectTypeOf<ResolvePropType<never>>().toBeNever()
  })

  it('EpPropMergeType', () => {
    expectTypeOf<NPropMergeType<StringConstructor | NumberConstructor, 'str', 1>>().toEqualTypeOf<'str' | 1>()
    expectTypeOf<NPropMergeType<NumberConstructor, 2 | 3, 4>>().toEqualTypeOf<2 | 3 | 4>()
  })

  it('EpPropInputDefault', () => {
    expectTypeOf<NPropInputDefault<true, 1>>().toBeNever()
    expectTypeOf<NPropInputDefault<false, 1>>().toEqualTypeOf<1 | (() => 1)>()
  })

  it('EpProp', () => {
    expectTypeOf<NProp<'1', '2', false>>().toEqualTypeOf<{
    ...
    expectTypeOf<NProp<'1', '2', true>>().toEqualTypeOf<{
      readonly type: PropType<'1'>
  ...
  it('Type, validator and Object default value', () => {
    ...
    expectTypeOf(
      buildProp({
        type: definePropType<Options>(Object),
        default: () => ({ key: 'value' }),
        validator: (_val: unknown): _val is string => true,
      } as const),
    ).toEqualTypeOf<{
  ...
  it('Type, validator, required', () => {
    expectTypeOf(
      buildProp({
        ...
        required: true,
        validator: (_val: unknown): _val is number => true,
      } as const),
    ).toEqualTypeOf<{
      readonly type: PropType<number | 'a' | 'b' | 'c'>
      readonly required: true

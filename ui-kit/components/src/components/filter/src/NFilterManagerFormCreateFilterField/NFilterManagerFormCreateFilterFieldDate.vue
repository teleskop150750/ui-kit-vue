...
import {
  nFilterManagerFormCreateFilterFieldDateEmits,
  nFilterManagerFormCreateFilterFieldDateProps,
} from './filter-manager-form-create-filter-field-date.model'

const props = defineProps(nFilterManagerFormCreateFilterFieldDateProps)
const emit = defineEmits(nFilterManagerFormCreateFilterFieldDateEmits)

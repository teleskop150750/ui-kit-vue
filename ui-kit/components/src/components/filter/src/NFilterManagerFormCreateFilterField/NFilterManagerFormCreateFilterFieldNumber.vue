...
import {
  nFilterManagerFormCreateFilterFieldNumberEmits,
  nFilterManagerFormCreateFilterFieldNumberProps,
} from './filter-manager-form-create-filter-field-number.model'

const props = defineProps(nFilterManagerFormCreateFilterFieldNumberProps)
const emit = defineEmits(nFilterManagerFormCreateFilterFieldNumberEmits)

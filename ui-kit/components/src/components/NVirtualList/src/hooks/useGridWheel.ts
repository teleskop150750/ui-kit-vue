import { cAF, isFirefox, type Nillable, rAF } from '@nado/ui-kit-utils'
...
export const useGridWheel = (
  ...
  const onWheel = (e: WheelEvent) => {
    ...
    // Имитация собственного поведения при использовании сенсорной панели/трекпада для управления колесом.
    ...
    // Специальный случай для Windows с клавишей Shift + прокрутка колеса
    if (e.shiftKey && y !== 0) {
      x = y
      y = 0
    }

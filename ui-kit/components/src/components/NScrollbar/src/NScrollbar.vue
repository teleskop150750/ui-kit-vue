...
import { addUnit, debugWarn, isNumber, isObject } from '@nado/ui-kit-utils'
import { useResizeObserver } from '@vueuse/core'
import { computed, nextTick, onMounted, onUpdated, provide, reactive, ref, type StyleValue, watch } from 'vue'

import { scrollbarEmits, scrollbarProps } from './NScrollbar.model'
import type { NScrollbarBarInstance } from './NScrollbarBar.model'
import NScrollbarBar from './NScrollbarBar.vue'
...
const barRef = ref<NScrollbarBarInstance>()

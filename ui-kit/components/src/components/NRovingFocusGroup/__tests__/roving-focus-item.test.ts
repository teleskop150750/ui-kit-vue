...
} from '../src/NRovingFocusGroup.model'
...
const focusItemClasses = 'item-kls'
...
describe('<NRovingFocusItem />', () => {
  ...
  function findItems() {
    return wrapper.findAllComponents(NRovingFocusItem)
  }

  function findDOMItems() {
    return wrapper.findAll(`.${focusItemClasses}`)
  }
  ...
  describe('roving focus', () => {
    it('should be able to handle mousedown event', async () => {
      ...
      const emittedEvents = firstItem!.emitted().mousedown as any

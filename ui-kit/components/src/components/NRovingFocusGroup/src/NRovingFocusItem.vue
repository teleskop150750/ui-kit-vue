...
import { NCollectionItem, ROVING_FOCUS_COLLECTION_INJECTION_KEY } from './NRovingFocusGroup.model'
import { povingFocusItemEmits, povingFocusItemProps } from './NRovingFocusItem.model'
...
const props = defineProps(povingFocusItemProps)
const emit = defineEmits(povingFocusItemEmits)

...
import type { CheckboxValueType } from './NCheckbox.model'
...
export type NCheckboxGroupProps = ExtractPropTypes<typeof checkboxGroupProps>
export type NCheckboxGroupEmits = typeof checkboxGroupEmits

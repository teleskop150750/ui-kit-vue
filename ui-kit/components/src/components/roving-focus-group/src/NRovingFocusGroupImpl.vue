...
import {
  nPovingFocusGroupEmits,
  nPovingFocusGroupProps,
  ROVING_FOCUS_COLLECTION_INJECTION_KEY,
} from './roving-focus-group.model'
import { ROVING_FOCUS_GROUP_INJECTION_KEY } from './tokens'
import { focusFirst } from './utils'

const props = defineProps(nPovingFocusGroupProps)
const emit = defineEmits(nPovingFocusGroupEmits)

...
import {
  filterManagerFormCreateFilterFieldEmits,
  filterManagerFormCreateFilterFieldProps,
} from './NFilterManagerFormCreateFilterField.model'
...
const props = defineProps(filterManagerFormCreateFilterFieldProps)
const emit = defineEmits(filterManagerFormCreateFilterFieldEmits)

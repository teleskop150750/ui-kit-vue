...
import { filterSimpleListButtonAddEmits, filterSimpleListButtonAddProps } from './NFilterSimpleListButtonAdd.model'

const props = defineProps(filterSimpleListButtonAddProps)
const emit = defineEmits(filterSimpleListButtonAddEmits)

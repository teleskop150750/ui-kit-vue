...
import { useFormDisabled, useFormSize } from '../../../NForm'
import type { NRadioEmits, NRadioProps } from '../NRadio.model'
import { RADIO_GROUP_INJECTION_KEY } from '../tokens'
...
export function useRadio(
  ...
  const radioGroup = inject(RADIO_GROUP_INJECTION_KEY, undefined)

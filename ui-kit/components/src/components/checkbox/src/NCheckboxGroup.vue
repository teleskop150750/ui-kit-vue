...
import { type CheckboxGroupValueType, nCheckboxGroupEmits, nCheckboxGroupProps } from './checkbox-group.model'
import { CHECKBOX_GROUP_INJECTION_KEY } from './tokens'

const props = defineProps(nCheckboxGroupProps)

const emit = defineEmits(nCheckboxGroupEmits)

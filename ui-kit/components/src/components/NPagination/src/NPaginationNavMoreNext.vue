...
import { paginationNavMoreNextEmits, paginationNavMoreNextProps } from './NPaginationNavMoreNext.model'

const props = defineProps(paginationNavMoreNextProps)
const emit = defineEmits(paginationNavMoreNextEmits)

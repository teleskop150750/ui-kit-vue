...
import { paginationNavMorePrevEmits, paginationNavMorePrevProps } from './NPaginationNavMorePrev.model'

const props = defineProps(paginationNavMorePrevProps)
const emit = defineEmits(paginationNavMorePrevEmits)

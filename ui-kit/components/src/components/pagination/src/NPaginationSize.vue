...
import { NOption, NSelect, type SelectVModel } from '../../select'
import { nPaginationSizeEmits, nPaginationSizeProps } from './pagination-size.model'

const props = defineProps(nPaginationSizeProps)

const emit = defineEmits(nPaginationSizeEmits)

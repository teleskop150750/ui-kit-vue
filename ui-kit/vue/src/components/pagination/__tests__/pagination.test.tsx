...
describe('Pagination', () => {
  describe('test invalid usages', () => {
    ...
    //   expect(console.warn).not.toHaveBeenCalled()
    //   const wrapper = mount(() => <Pagination total={100} currentPage={1}></Pagination>)
    ...
    //   expect(console.warn).not.toHaveBeenCalled()
    //   const wrapper = mount(() => <Pagination layout="sizes, pager" pageCount={10}></Pagination>)
    ...
    //   expect(console.warn).not.toHaveBeenCalled()
    //   const wrapper = mount(() => <Pagination layout="sizes, pager" pageSize={10}></Pagination>)
  ...
  //   const layoutRef = ref('')
  //   const wrapper = mount(() => <Pagination total={100} layout={layoutRef.value}></Pagination>)
  ...
  //     ['sizes', '.n-pagination__sizes'],
  //     ['prev', 'button.btn-prev'],
  //     ['pager', 'ul.el-pager'],
  //     ['next', 'button.btn-next'],
  //     ['jumper', '.n-pagination__jump'],
  //     ['total', '.n-pagination__total'],
  //   ]
  ...
  //     await nextTick()
  //     assertElementsExistence(wrapper, ['.n-pagination__total', '.n-pagination__rightwrapper'], true)
  //   })
  ...
  //       wrapper,
  //       ['.n-pagination__rightwrapper', 'button.btn-prev', 'ul.el-pager', 'button.btn-next', '.n-pagination__jump'],
  //       true,
  //     )
  //   })
  ...
  //     expect(wrapper.vm.$el.classList.contains('n-pagination--small')).toBe(true)
  //   })

  //   test('test with background', async () => {
  //     const withBackground = ref(true)
  //     const wrapper = mount(() => <Pagination total={100} background={withBackground.value}></Pagination>)
  ...
  //     const prev = wrapper.find('.n-pagination .btn-prev')
  //     const next = wrapper.find('.n-pagination .btn-next')
  //     const pagers = wrapper.findAll('.n-pagination .el-pager .number')
  ...
  //     const wrapper = mount(() => <Pagination total={100} disabled={disabled.value}></Pagination>)

...
import { BAR_MAP } from '@ui/components/scrollbar'
import { useNamespace } from '@ui/hooks'
import { cAF, type Nillable, type Nullable, rAF } from '@ui/utils'
...
import { virtualizedScrollbarProps } from './virtual-list.model'

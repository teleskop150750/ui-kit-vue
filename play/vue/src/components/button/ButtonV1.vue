...
import { NButton, nButtonAppearances, nButtonMods } from '@ui'
...
<template>
  ...
  <div class="row">
    <NButton label="Кнопка" size="small" :icon-right="NIconPlus" @click="buttonOnClick" />
    <NButton label="Кнопка" size="default" :icon-right="NIconPlus" @click="buttonOnClick" />
